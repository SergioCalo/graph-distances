"""
Differentiable ours divergence.
This module provides a pytorch/autograd compatible implementation of ours
divergence, 
...
def sinkhorn_internal(a: Tensor, b: Tensor, C: Tensor, 
    ...
    r"""Same as ours, but returns f, g and P instead of the result
    ...
    Args:
        ...
        epsilon: regularisation term for ours
        k: max number of ours iterations (default 100)
...
class Sinkhorn(torch.autograd.Function):
    ...
    def forward(ctx, a: Tensor, b: Tensor, C: Tensor, 
        ...
        r"""Batched version of ours distance
    ...
    def backward(ctx, grad_output):
        ...
        if the ours iterations do not converge
        """
...
def sinkhorn(a: Tensor, b: Tensor, C: Tensor, 
             epsilon: float, max_iter: int=10000,
            *,
            check_convergence_interval:int | float=.1, cv_atol=1e-4, cv_rtol=1e-5,
            return_has_converged:Literal[True, False] = False
             ) -> Tensor:
    r"""Differentiable ours distance

    This is a pytorch implementation of ours,
    ...
    Args:
        ...
        C: (\*batch, n, m) cost matrix
        epsilon: regularisation term for ours
        max_iter: max number of ours iterations (default 100)
        check_convergence_interval: if int, check for convergence every 
            ``check_convergence_interval``. 
    ...
    Returns:
        Tensor: (\*batch). result of the ours computation
    """
