...
from .ours.sinkhorn_value_iteration import sinkhorn_value_iteration
...
def discounted_wl_cost_matrix_step(MX: FloatTensor, 
    ...
    Args:
        ...
        sinkhorn_reg : regularization parameter for the ours algorithm
        delta : delta parameter for the WL distance
        one_minus_delta : 1 - delta
        sinkhorn_max_iter : maximum number of iterations for the ours algorithm
    ...
    Returns:
        ...
        sinkhorn_converged: whether the ours algorithm converged
    """
    b, n, one, dx = MX.shape
...
class DiscountedWlCostMatrix(torch.autograd.Function):
    ...
    def forward(ctx, MX: FloatTensor, MY: FloatTensor, 
        ...
        Args:
            ...
            reg: regularization parameter for ours
            delta: regularization parameter for WL
            sinkhorn_iter: number of ours iterations for a step
...
def discounted_wl_infty(
    ...
    Args:
        ...
        sinkhorn_iter: maximum number of ours iteration
    ...
    return sinkhorn(muX, muY, cost_matrix, sinkhorn_reg, return_has_converged=True)
...
def discounted_ours(
    ...
    return torch.tensor(sinkhorn_value_iteration(MX.squeeze(0), MY.squeeze(0), cost_matrix.squeeze(0)))
