...
from experiments.utils.grakel_datasets import Dataset
from experiments.utils.distance_matrix import compute_distance_matrix as wl_distance_matrix, compute_distance_matrix_fgw as fgw_distance_matrix, compute_distance_matrix_dwl
from experiments.utils.ksvm_utils import KreinSVC
from experiments.utils.distance_matrix import compute_distance_matrix_ours
...
def compute_distance_matrices(datasets_yaml: Path, output_file: Path, 
    ...
    match model:
        case "OURS":
            for ds in datasets:
                matrices[ds.title] = compute_distance_matrix_ours(
...
def argument_parser(parser=None):
    ...
    parser_compute_distance_matrices.add_argument(
            ...
            type=str,
            default="WL_DELTA",
            choices=[ "OURS", "WL_DELTA", "WL", "WLOA", "DWL", "GRAPHLET", "FGW"],
            help="Model to use"
    )
    ...
    parser_compute_distance_matrices.add_argument(
            ...
            type=float,
            default=None,
            help="epsilon parameter for ours",
    )
